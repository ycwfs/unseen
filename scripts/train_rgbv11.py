...
# model = YOLO('/data1/code/competition/tianchi/unseen/yolov12/ultralytics/cfg/models/11/yolo11srgb.yaml')
model = YOLO('/data1/code/competition/tianchi/unseen/yolov12/yolo11s.pt')
