...
class RandomHSV:
    ...
    def __call__(self, labels):
        ...
        if self.hgain or self.sgain or self.vgain:
            # 50% chance to apply HSV augmentation
...
class LetterBox:
    ...
    def __call__(self, labels=None, image=None):
        ...
        if shape[::-1] != new_unpad:  # resize
            ...
            if "ir" in labels:
                ir = cv2.resize(ir, new_unpad, interpolation=cv2.INTER_LINEAR)
    ...
    def __call__(self, labels):
        ...
        Args:
            labels (Dict): A dictionary containing image and annotation data with the following keys:
                ...
                - 'ir': The input infrared image as a numpy array.
        ...
        Returns:
            (Dict): A dictionary with formatted data, including:
                ...
                - 'ir': Formatted infrared image tensor (if present).
