...
model = YOLO("/data1/wangqiurui/code/competition/tianchi/unseen/yolov12/yolov11s_rgb_1280/train/weights/epoch10.pt")
...
res = model.predict("/data1/wangqiurui/code/ossutil-v1.7.19-linux-amd64/rgb_unseen/val/images/", 
                    ...
                    save_txt=True, save_conf=True, project='yolov11s_rgb_1280', name='1280_epoch10_res')
for r in res:
    print(r.summary())